                    ...
                    <div class="col-md-12 col-lg-9">
                        ...
                        <div class="sports-news mb60 xs-mt-50">
                            ...
                            <div class="sports-title mb20">
                                <h3>{{$post->title}}</h3>
                                <p>By <span>{{$post->user->name}}</span> / {{$post->published_at->diffForHUmans()}} / 3 Comments / Categories:
                                    <a href="{{route('category', $post->category->id)}}"> <span>{{$post->category->name}}</span></a></p>
                            </div>
